...
class Employee(models.Model):
	...
	user 	= models.OneToOneField(User, on_delete=models.PROTECT, related_name='user', default='')
...
class Student(models.Model):
	...
	user 	 = models.OneToOneField(User, on_delete=models.PROTECT, related_name='student_user', default='')
